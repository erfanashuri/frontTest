        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    ...
                    <a href="index.php?cat=<?php echo $row['id']; ?>" class="list-group-item"><?php echo $row['cat-name']; ?></a>
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    ...
                    if (isset($_GET["cat"])){
                        $cat=$_GET["cat"];
                        $query=mysqli_query($connection,query:"SELECT * FROM `products` WHERE cat_id = '$cat' ");
                    }else{
                    $query=mysqli_query($connection,query:"SELECT * FROM `products`");
                    }
                    while ($row = mysqli_fetch_array($query)):?>
