...
<?php  
$id = $_GET['id']; 
$query = mysqli_query($connection , query:"SELECT * FROM `products` WHERE id = '$id' " );
...
<body>
    ...
    <div class="container">
        ...
        <a href="index.php?cat=<?php echo $cat_row['id']; ?>" class="list-group-item"><?php echo $cat_row['cat-name']; ?></a>
